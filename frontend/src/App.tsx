    ...
    <div className="h-screen bg-neutral-950 text-white flex flex-col overflow-hidden">
      ...
      <div className="flex flex-1 min-h-0">
        <div className="flex-1 flex flex-col overflow-hidden min-w-0">
          ...
          {/* Toolbar above video */}
          <div className="shrink-0 mx-5 mt-4 mb-3 px-5 py-3.5 rounded-2xl bg-white/[0.03] border border-white/[0.06] flex items-center justify-between backdrop-blur-sm">
          ...
          <div className="shrink-0 mx-5 mb-5 px-4 py-3 rounded-xl bg-white/[0.03] border border-white/[0.06] text-sm space-y-2.5">
            ...
            {currentClip ? (
              <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1 pt-3 mt-1 border-t border-white/[0.06]">
              ...
              <div className="flex justify-center pt-3 mt-1 border-t border-white/[0.06]">
                <span className="text-neutral-400">{clips.length} clip{clips.length === 1 ? '' : 's'} · pick one in the assistant</span>
              </div>
            ) : (
              <div className="flex justify-center pt-3 mt-1 border-t border-white/[0.06] text-xs text-neutral-500">
